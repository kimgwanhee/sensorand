...
public class MainActivity extends AppCompatActivity {
    protected static final int BTH_ENABLE = 1234;
    ...
    protected String sBthName = "GWANHEE";
    ...
    protected Button btFind, btConnect, btRead, btWrite, btViewSensor0, btdis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btdis = (Button) findViewById(R.id.btdis);
